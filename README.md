...
[![CI](https://github.com/unnft/evmfs-browser-extension/actions/workflows/ci.yml/badge.svg)](https://github.com/unnft/evmfs-browser-extension/actions/workflows/ci.yml)
...
1. Download `evmfs-browser-plugin.zip` from [Releases](https://github.com/unnft/evmfs-browser-extension/releases)
2. Unzip to a folder
...
```bash
git clone https://github.com/unnft/evmfs-browser-extension.git
...
```
 Omnibox /         Background SW           Viewer Page
 URL bar /    -->  (resolve, fetch,   -->  (loading UI)
 Popup             decompress)                  |
                                           postMessage
                                                v
                                            Sandbox
